...
public class TwoFactorEnableController {
    ...
    /**
     * <p>Instantiates an instance of {@link TwoFactorEnableController}.</p>
     * @param qrUrl URL to retrieve 2FA QR from
     * @param converter A {@link IntegerConverter} to use
     */
