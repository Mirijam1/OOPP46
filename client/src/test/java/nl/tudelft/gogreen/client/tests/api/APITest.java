...
public class APITest {
    ...
    @Test
    public void retrieveProgressingAchievements() {
        testAttemptAdminAuthentication();
        API.retrieveProgressingAchievements(new ServerCallback<Object, CompletedAchievements[]>() {
            @Override
            public void run() {
                assertTrue(getResult() != null);
            }
    ...
    @Test
    public void submitverificationvode() {
        testAttemptAdminAuthentication();
        ...
        }, new User("gogreenuser", null, null), 1234567);
    }
