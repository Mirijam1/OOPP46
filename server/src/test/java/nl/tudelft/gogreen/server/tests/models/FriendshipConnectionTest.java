...
public class FriendshipConnectionTest {
    ...
    @Before
    public void setUp() {
        User initUser = new User(null, null, null, "user1", null, null, false, false, null, false, true, null);
        User invitedUser = new User(null, null, null, "user2", null, null,false, false, null, false, true, null);
