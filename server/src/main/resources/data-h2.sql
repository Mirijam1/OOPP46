...
--  User: admin
--  Password: password
INSERT INTO USER_TABLE (USER_ID, EXTERNAL_ID, ACC_ACTIVATED, ACC_EXPIRED, ACC_LOCKED, PASSWORD, NAME) VALUES ('054597382efa45f5b3cfebcdb16d6cd4', '054597382efa45f5b3cfbecdb16d6cd4', 'true', 'false', 'false', '$2a$10$67OBfdBphsEdLr7hlD2XDOA1USyt5jCqJMmMUiByemWtRrbKObFfi', 'admin');
...
--  User: gogreenuser
--  Password: password
INSERT INTO USER_TABLE (USER_ID, EXTERNAL_ID, ACC_ACTIVATED, ACC_EXPIRED, ACC_LOCKED, PASSWORD, NAME) VALUES ('674597382efa45f5b3cfebcdb16d6cd4', '674597382eaf45f5b3cfebcdb16d6cd4', 'true', 'false', 'false', '$2a$10$67OBfdBphsEdLr7hlD2XDOA1USyt5jCqJMmMUiByemWtRrbKObFfi', 'gogreenuser');
INSERT INTO USER_PROFILE (ID, USER_REF, POINTS) VALUES ('676573882efa45f5b3cfebcdb16d1cd4', '674597382efa45f5b3cfebcdb16d6cd4', '0');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (0, 'Amount of meals', 'FLOAT', 'amount', 0, 1, 10, '1'), (7, 'Amount of calories', 'FLOAT', 'cal', 0, 250, 750, '400');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (1, 'KM biked', 'FLOAT', 'distance', 1, 1, 50, '10');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (4, 'KM travelled', 'FLOAT', 'distance', 4, 5, 125, '40');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (8, 'KM travelled', 'FLOAT', 'distance', 7, 5, 150, '50');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (5, 'Degrees dropped', 'FLOAT', 'degrees', 5, 0, 10, '3'), (9, 'Amount of residents', 'FLOAT', 'residents', 5, 1, 12, '4');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (6, 'Panels installed', 'FLOAT', 'panels', 6, 1, 10, '2'), (10, 'Amount of residents', 'FLOAT', 'residents', 6, 1, 12, '4');

--   Activity: Replace lights with LED-lights (8)
--     Options: 11
INSERT INTO ACTIVITY (ID, NAME, DESCRIPTION, INTERNAL_NAME, CATEGORY) VALUES (8, 'LED lights', 'Replace lights with LED-lights', 'LED', 2);
INSERT INTO TRIGGERS (ID, TRIGGER) VALUES (8, 'SUBMITTED_ACTIVITY');
INSERT INTO TRIGGERS (ID, TRIGGER) VALUES (8, 'COMPLETED_UTILITIES_ACTIVITY');
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (11, 'Bulbs replaced', 'FLOAT', 'energy', 8, 1, 15, '8');
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY, MIN_VALUE, MAX_VALUE, DEFAULT_VALUE) VALUES (2, 'Trees planted', 'FLOAT', 'trees', 2, 1, 20, '10');

-- Inserting badges
INSERT INTO BADGE (ID, NAME, MESSAGE, TRIGGER) VALUES (0, 'Completed activity', 'You completed an activity!', 'SUBMITTED_ACTIVITY');
INSERT INTO TRIGGERS_COMPLETE (ID, TRIGGER) VALUES (0, 'ACHIEVED_BADGE');
...
INSERT INTO TRIGGERS_COMPLETE (ID, TRIGGER) VALUES (1, 'ACHIEVED_BADGE');

INSERT INTO BADGE (ID, NAME, MESSAGE, TRIGGER) VALUES (2, 'Completed transport activity', 'You completed a transport activity!', 'COMPLETED_TRANSPORT_ACTIVITY');
INSERT INTO TRIGGERS_COMPLETE (ID, TRIGGER) VALUES (2, 'ACHIEVED_BADGE');

INSERT INTO BADGE (ID, NAME, MESSAGE, TRIGGER) VALUES (3, 'Completed energy activity', 'You completed a energy activity!', 'COMPLETED_ENERGY_ACTIVITY');
INSERT INTO TRIGGERS_COMPLETE (ID, TRIGGER) VALUES (3, 'ACHIEVED_BADGE');
...
INSERT INTO TRIGGERS_COMPLETE (ID, TRIGGER) VALUES (4, 'ACHIEVED_BADGE');

-- Inserting achievements
INSERT INTO ACHIEVEMENT (ID, NAME, MESSAGE, DESCRIPTION, REQUIRED_TRIGGERS, TRIGGER) VALUES (0, 'Make the world a better place', 'WIP', 'Complete 3 activities', 3, 'SUBMITTED_ACTIVITY');
INSERT INTO ACHIEVEMENT (ID, NAME, MESSAGE, DESCRIPTION, REQUIRED_TRIGGERS, TRIGGER) VALUES (1, 'Badge collector', 'WIP', 'Earn 5 badges', 5, 'ACHIEVED_BADGE');