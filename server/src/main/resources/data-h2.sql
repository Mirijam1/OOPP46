...
-- INSERT INTO CATEGORY (CATEGORY_ID, NAME, DESCRIPTION) VALUES ('1', 'Food', 'Food items'),('2', 'Transport', 'Food items'),('3', 'Energy', 'Food items'),('4', 'Misc', 'Food items');
-- INSERT INTO ACTIVITY (ACTIVITY_ID, NAME,  CATEGORY,POINTS) VALUES ('1', 'Eating a veg meal', '1','0.3');