...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (0, 'Amount of meals', 'FLOAT', 'amount', 0), (7, 'Amount of calories', 'FLOAT', 'cal', 0) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (1, 'Kilometers biked', 'FLOAT', 'distance', 1) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (4, 'Kilometers travelled', 'FLOAT', 'distance', 4) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (8, 'Kilometers travelled', 'FLOAT', 'distance', 7) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (5, 'Degrees Celsius dropped', 'FLOAT', 'degrees', 5), (9, 'Amount of residents', 'FLOAT', 'residents', 5) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (6, 'Solar panels installed', 'FLOAT', 'panels', 6), (10, 'Amount of residents', 'FLOAT', 'residents', 6) ON CONFLICT DO NOTHING;
...
INSERT INTO ACTIVITY_OPTION (ID, DESCRIPTION, INPUT_TYPE, INTERNAL_NAME, ACTIVITY) VALUES (2, 'Trees planted', 'FLOAT', 'trees', 2) ON CONFLICT DO NOTHING;
