...
--  User: admin
--  Password: password
INSERT INTO USER_TABLE (USER_ID, EXTERNAL_ID, ACC_ACTIVATED, ACC_EXPIRED, ACC_LOCKED, PASSWORD, NAME) VALUES ('054597382efa45f5b3cfebcdb16d6cd4', '054597382efa45f5b3cfbecdb16d6cd4', 'true', 'false', 'false', '$2a$10$67OBfdBphsEdLr7hlD2XDOA1USyt5jCqJMmMUiByemWtRrbKObFfi', 'admin') ON CONFLICT DO NOTHING;
...
--  User: gogreenuser
--  Password: password
INSERT INTO USER_TABLE (USER_ID, EXTERNAL_ID, ACC_ACTIVATED, ACC_EXPIRED, ACC_LOCKED, PASSWORD, NAME) VALUES ('674597382efa45f5b3cfebcdb16d6cd4', '674597382eaf45f5b3cfebcdb16d6cd4', 'true', 'false', 'false', '$2a$10$67OBfdBphsEdLr7hlD2XDOA1USyt5jCqJMmMUiByemWtRrbKObFfi', 'gogreenuser') ON CONFLICT DO NOTHING;
